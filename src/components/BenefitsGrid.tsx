        ...
        {benefits.map((motivation, index) => (
          <div key={index} className={clsx("w-full flex flex-col items-center md:items-start gap-4")}>
            ...
            <div className="flex flex-col">
              <Headline level={2} className="lg:text-xl text-center md:text-left" >
                {motivation.title}
              </Headline>
              <p className=" text-center md:text-left mt-1 leading-[1.6] text-dark-secondary max-w-[50ch] md:max-w-[65ch]">
